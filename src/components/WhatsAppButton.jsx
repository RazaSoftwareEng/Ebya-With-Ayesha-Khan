...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 left-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] p-4 text-white shadow-xl shadow-black/20 transition hover:pr-5"
    >
